...
function NavBar({ currentUser, setCurrentUser }) {
  ...
  const [registrationModalVisibility, setRegistrationModalVisibility] =
  ...
  return (
    <div className="navBarContainer">
      <div className="logoContainer">
        ...
        <Link to="/contests" className="btn menuBtn">
          Contests
        </Link>
        <Link to="/problemset" className="btn menuBtn">
          Problems
        </Link>
      </div>
      ...
      />
      <RegistrationModal
        open={registrationModalVisibility}
        onAuthenticated={(user) => {
          setCurrentUser(user);
...
function LoginModal({ open, handleClose, onAuthenticated }) {
  ...
  function submitLoginForm(e) {
    ...
    UserService.authenticate(data).then((user) => {
      if (!user) {
