  ...
  async function submitSolution() {
    if (!currentUser) {
      ModalManager.showAlert(
        "Please log in or sign up to submit solutions",
    ...
    >
      <Box sx={style}>
        <div className="codePreviewModalContainer">
          ...
          <button
            disabled={submissionStatus === NOT_JUDGED}
        ...
        {submissionStatus !== NOT_SUBMITTED && (
          <table>
            <thead>
              <tr>
                <th>Time</th> <th>Vertict</th> <th>Exec. time</th>{" "}
              </tr>
            </thead>
            <tbody>
              <tr>
                <td>
                  {submissionStatus === JUDGED && (
                    <Link
                      to={`${Global.CLIENT_URL}/viewSubmission/${problem.contestId}/${newSubmissionId}`}
                    >
                ...
                <td>{submissionInfo.verdict}</td>
                <td>{submissionInfo.execTime}</td>
              </tr>
            </tbody>
          </table>
        )}
            ...
            <tr>
              ...
              <td colSpan={2} style={{}}>
                ...
                >
                  ...
                  <option value="java">
                    Java (The name of the main class must be 'Solution')
                  </option>
                </select>
              </td>
            </tr>
